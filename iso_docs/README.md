...
something in use today in practice but not explicitly described in the specification. This updates
an earlier version of this short proposal, to say what happens when the ranges of duplicat axis
entries differ.
