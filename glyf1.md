...
**Note:** While it is the (undocumented?) behavior of the glyf table that glyphs loaded are shifted to align their LSB to that specified in the `hmtx` table, much like regular Component glyphs, this does not apply to VariableComponent glyphs being loaded as part of a VariableComposite glyph.
