...
For a Format 0 `loca` table (`head.indexToLocFormat` = 0), the number of glyphs in the font is defined as the length of the `loca` table divided by 2, minus 1; for a Format 1 `loca` table (`head.indexToLocFormat` = 1), the number of glyphs in the font is defined as the length of the `loca` table divided by 4, minus 1.

[issue](https://github.com/harfbuzz/boring-expansion-spec/issues/8)
