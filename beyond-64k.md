...
Glyph table composites that need to access glyphs with glyph IDs larger than 65,535 will have to use the VarComposites format which supports 24-bit GIDs.
